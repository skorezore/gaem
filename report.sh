...
{
	$glog1 --pretty="<br /><p>Latest commit: <a href=\"https://$TRAVIS_REPO_SLUG/commit/%H/\">%s</a> by <a href=\"mailto:%cE\">%cN</a> on "
	date -d "$($glog1 --date=rfc --pretty='%ad')" +"$date_format</p>"
	echo "<div id=\"footer\"><address><a href=https://github.com/Skorezore/Gaem>Gaem</a> created and maintained by <a href=\"mailto:skorezore@gmail.com?cc=nabijaczleweli@gmail.com&amp;subject=Gaem%20-%20\">Skorezore &amp; nabijaczleweli</a>(<a href=\"https://github.com/Skorezore\">$github_octicon</a> &amp; <a href=\"https://github.com/nabijaczleweli)\">$github_octicon</a>)<br /><a href=\"https://github.com/$TRAVIS_REPO_SLUG/blob/master/report.sh\">Line report generator script</a> by <a href=\"mailto:nabijaczleweli@gmail.com?cc=skorezore@gmail.com&amp;subject=Gaem%20-%20line%20report%20-%20\">nabijaczleweli</a></address>"
	date +"<small>generated by <a class=\" initialism\" href=\"http://cloc.sourceforge.net\">CLOC</a> at $date_format</small><br />"
	echo '<small>these metrics are <em>not</em> 100% accurate because smart counting <span class="initialism">SLOC</span> is tricky</small><br /><small>uses the *amazing* <a href="http://getbootstrap.com/">bootstrap</a> theme <a class=" initialism" href="https://github.com/kristopolous/BOOTSTRA.386">BOOTSTRA.386</a> by <a href="https://github.com/kristopolous"><abbr title="Chris McKenzie">kristopolous</abbr></a></small></div>'
} | python -c "
import fileinput, sys
for lines in fileinput.input('report.html', inplace=True):
  print(lines.replace('APPEND_MARKER', sys.stdin.read()))
"
