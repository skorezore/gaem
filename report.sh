...
cloc --3 --by-file-by-lang --by-percent c --xml --progress-rate=10 --out=report.xml --force-lang=Makefile source/ Makefile
{
	...
	echo '<div id="footer"><address><a href="https://github.com/Skorezore/Gaem">Gaem</a> created and maintained by <a href="mailto:skorezore@gmail.com?cc=nabijaczleweli@gmail.com&amp;subject=Gaem%20-%20">Skorezore &amp; nabijaczleweli</a><br /><a href="https://github.com/Skorezore/Gaem/blob/master/report.sh">Line report generator script</a> by <a href="mailto:nabijaczleweli@gmail.com?cc=skorezore@gmail.com&amp;subject=Gaem%20-%20line%20report%20-%20">nabijaczleweli</a></address>'; \
